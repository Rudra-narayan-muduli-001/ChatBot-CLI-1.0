...
MODULES:
  chat_service      - Sessions (get/create, load from disk), message history for LLM, save to disk.
  groq_service      - General chat: retrieve context from vectore store, build prompt, call Groq LLM.
